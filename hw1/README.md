...
Train translation parameters for five iterations on Model 1 and use them to initialize translation parameters of model 2, which is run for five iterations.
